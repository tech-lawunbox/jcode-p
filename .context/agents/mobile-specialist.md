...
description: Maintain iOS/mobile companion and design-plugin surfaces.
...
## Mission
Maintain iOS/mobile companion and design-plugin surfaces. Engage this agent when work touches its area and decisions should align with Jcode's Rust workspace, self-dev loop, and tool-driven validation.

## Responsibilities
- Respect platform packaging; keep design assets in sync; validate mobile-specific build constraints.
