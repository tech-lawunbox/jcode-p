...
type: agent
name: Bug Fixer
description: Reproduce, isolate, and fix regressions with minimal side effects.
agentType: bug-fixer
phases: [P, E]
...
## Mission
Reproduce, isolate, and fix regressions with minimal side effects. Engage this agent when work touches its area and decisions should align with Jcode's Rust workspace, self-dev loop, and tool-driven validation.

## Responsibilities
- Create a repro; identify root cause; patch narrowly; add or run regression tests; document skipped checks.
