...
description: Keep user and contributor documentation accurate and task-oriented.
...
## Mission
Keep user and contributor documentation accurate and task-oriented. Engage this agent when work touches its area and decisions should align with Jcode's Rust workspace, self-dev loop, and tool-driven validation.

## Responsibilities
- Read code before writing; include exact commands; link related docs; remove stale TODOs.
