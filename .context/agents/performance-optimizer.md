...
description: Measure and improve memory, startup, rendering, and agent runtime performance.
...
## Mission
Measure and improve memory, startup, rendering, and agent runtime performance. Engage this agent when work touches its area and decisions should align with Jcode's Rust workspace, self-dev loop, and tool-driven validation.

## Responsibilities
- Benchmark before and after; use profiling scripts; optimize real bottlenecks; avoid speculative complexity.
