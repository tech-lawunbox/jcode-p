...
description: Plan, implement, and verify new user-visible or platform features.
...
## Mission
Plan, implement, and verify new user-visible or platform features. Engage this agent when work touches its area and decisions should align with Jcode's Rust workspace, self-dev loop, and tool-driven validation.

## Responsibilities
- Fit existing crate boundaries; add tests; update docs; use selfdev reload for Jcode changes.
